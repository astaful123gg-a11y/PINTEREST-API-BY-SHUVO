...
# truststore.inject_into_ssl() (above) makes Python's ssl module verify
# against the OS trust store directly. Leave verify=True (default) so
# requests uses that patched context instead of a pinned certifi bundle.
SESSION.verify = True
